# This script takes data from two excel files and populates a database with
# two tables confluence and essences. These tables can be used in other
# scripts to interact with and build various persons.
